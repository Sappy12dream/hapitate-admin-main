...
const Pending_verifications=({authorized})=>{
  if(!authorized)
  {
    return <Redirect to="/"/>
  }
  ...
  <div className="mr-breadcrumb">
    <div className="row">
      <div className="col-lg-12">
        <h4 className="heading">Pending Verifications</h4>
        <ul className="links">
          <li>
            ...
            <div id="geniustable_wrapper" className="dataTables_wrapper dt-bootstrap4 no-footer">
              ...
              <div className="row">
                <div className="col-sm-12">
                  <table id="geniustable" className="table table-hover dt-responsive dataTable no-footer dtr-inline" cellSpacing={0} width="100%" role="grid" aria-describedby="geniustable_info" style={{width: '100%'}}>
                    <thead>
                      <tr role="row">
                        <th className="sorting_disabled" rowSpan={1} colSpan={1} style={{width: '190px'}}>Vendor Name</th>
                        <th className="sorting_disabled" rowSpan={1} colSpan={1} style={{width: '184px'}}>Vendor Email</th>
                        <th className="sorting_disabled" rowSpan={1} colSpan={1} style={{width: '175px'}}>Descriptions</th>
                        <th className="sorting_disabled" rowSpan={1} colSpan={1} style={{width: '102px'}}>Status</th>
              ...
              <div className="row">
                <div className="col-sm-12 col-md-5">
                  <div className="dataTables_info" id="geniustable_info" role="status" aria-live="polite">Showing 0 to 0 of 0 entries</div>
                </div>
                <div className="col-sm-12 col-md-7">
                  <div className="dataTables_paginate paging_simple_numbers" id="geniustable_paginate">
                    <ul className="pagination">
                      ...
                      <li className="paginate_button page-item next disabled" id="geniustable_next"><a href="#" aria-controls="geniustable" data-dt-idx={1} tabIndex={0} className="page-link">Next</a></li>
                    </ul>
                  </div>
                </div>
              </div>
...
export default Pending_verifications;