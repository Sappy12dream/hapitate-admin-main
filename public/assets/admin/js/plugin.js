...
/*  jQuery Nice Select - v1.0
    ...
    /*!
     DataTables 1.10.18
     ТЉ2008-2018 SpryMedia Ltd - datatables.net/license
    */
    (function(h) {
    ...
    /*!
     ...
     ТЉ2011-2017 SpryMedia Ltd - datatables.net/license
    */
    (function(b) {
    ...
    */
    ...
    /*!
     ...
     ТЉ2016 SpryMedia Ltd - datatables.net/license
    */
    (function(c) {
    ...
    ! function(e, t) {
        ...
        function h(e, t) {
            for (var n in e = e || {}, t) t[n] && t[n].constructor && t[n].constructor === Object ? (e[n] = e[n] || {}, h(e[n], t[n])) : e[n] = t[n];
            return e
        }
        ...
        function C() {
            ...
            this.options.useCanvas = this.options.enableOrientation || E.call(this), this.data = {}, this.elements = {}, e = this.elements.boundary = document.createElement("div"), t = this.elements.viewport = document.createElement("div"), this.elements.img = document.createElement("img"), o = this.elements.overlay = document.createElement("div"), this.options.useCanvas ? (this.elements.canvas = document.createElement("canvas"), this.elements.preview = this.elements.canvas) : this.elements.preview = this.elements.img, d(e, "cr-boundary"), e.setAttribute("aria-dropeffect", "none"), r = this.options.boundary.width, a = this.options.boundary.height, p(e, {
                    ...
                    alt: "preview",
                    "aria-grabbed": "false"
                }), d(o, "cr-overlay"), this.element.appendChild(e), e.appendChild(this.elements.preview), e.appendChild(t), e.appendChild(o), d(this.element, "croppie-container"), this.options.customClass && d(this.element, this.options.customClass),
                function() {
                    ...
                    function h(e, t) {
                        var n = s.elements.preview.getBoundingClientRect(),
                            i = a.y + t,
                            o = a.x + e;
                        s.options.enforceBoundary ? (r.top > n.top + t && r.bottom < n.bottom + t && (a.y = i), r.left > n.left + e && r.right < n.right + e && (a.x = o)) : (a.y = i, a.x = o)
                    }
                    ...
                    function d(n) {
                        if ((void 0 === n.button || 0 === n.button) && (n.preventDefault(), !l)) {
                            ...
                            u(l), a = w.parse(s.elements.preview), window.addEventListener("mousemove", m), window.addEventListener("touchmove", m), window.addEventListener("mouseup", f), window.addEventListener("touchend", f), document.body.style[i] = "none", r = s.elements.viewport.getBoundingClientRect()
                        }
                    }
                    ...
                    function m(i) {
                        ...
                        h(d, m), f[n] = a.toString(), p(s.elements.preview, f), R.call(s), t = l, e = r
                    }
    
                    function f() {
                        u(l = !1), window.removeEventListener("mousemove", m), window.removeEventListener("touchmove", m), window.removeEventListener("mouseup", f), window.removeEventListener("touchend", f), document.body.style[i] = "", B.call(s), Y.call(s), o = 0
                    }
                    s.elements.overlay.addEventListener("mousedown", d), s.elements.viewport.addEventListener("keydown", function(e) {
                        ...
                        if (!e.shiftKey || e.keyCode !== l && e.keyCode !== c) {
                            if (s.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40) {
                                ...
                                a = w.parse(s.elements.preview), document.body.style[i] = "none", r = s.elements.viewport.getBoundingClientRect(),
                                    function(e) {
                                        var t = e[0],
                                            r = e[1],
                                            l = {};
                                        h(t, r), l[n] = a.toString(), p(s.elements.preview, l), R.call(s), document.body.style[i] = "", B.call(s), Y.call(s), o = 0
                                    }(d)
                            }
                        } else {
                            var m = 0;
                    ...
                    function o(t) {
                        ...
                        n = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, o = e._currentZoom + n * e._currentZoom, t.preventDefault(), L.call(e, o), i.call(e)
                    }
                    d(t, "cr-slider-wrap"), d(n, "cr-slider"), n.type = "range", n.step = "0.0001", n.value = 1, n.style.display = e.options.showZoomer ? "" : "none", n.setAttribute("aria-label", "zoom"), e.element.appendChild(t), t.appendChild(n), e._currentZoom = 1, e.elements.zoomer.addEventListener("input", i), e.elements.zoomer.addEventListener("change", i), e.options.mouseWheelZoom && (e.elements.boundary.addEventListener("mousewheel", o), e.elements.boundary.addEventListener("DOMMouseScroll", o))
                }.call(this), this.options.enableResize && function() {
                    var e, t, n, o, r, a, s, l = this,
                    ...
                    function f(i) {
                        ...
                        })), R.call(l), k.call(l), B.call(l), Y.call(l), n = s, t = a
                    }
        ...
        function _(e) {
            ...
            if (i._currentZoom = e ? e.value : i._currentZoom, o.scale = i._currentZoom, i.elements.zoomer.setAttribute("aria-valuenow", i._currentZoom), s(), i.options.enforceBoundary) {
                var l = function(e) {
        ...
        function B() {
            ...
            var c = {};
            c[t] = h.x + "px " + h.y + "px", c[n] = r.toString(), p(this.elements.preview, c)
        }
        ...
        function W() {
            var e, i = {},
                ...
                r = new w(0, 0, 1),
                a = new y;
            F.call(this) && !this.data.bound && (this.data.bound = !0, i[n] = r.toString(), i[t] = a.toString(), i.opacity = 1, p(o, i), e = this.elements.preview.getBoundingClientRect(), this._originalImageWidth = e.width, this._originalImageHeight = e.height, this.data.orientation = b(this.elements.img), this.options.enableZoom ? k.call(this, !0) : this._currentZoom = 1, r.scale = this._currentZoom, i[n] = r.toString(), p(o, i), this.data.points.length ? function(e) {
                ...
                var i = e[2] - e[0],
                    ...
                    c = -1 * e[0] + a.left,
                    d = {};
                d[t] = h + "px " + l + "px", d[n] = new w(c, u, s).toString(), p(this.elements.preview, d), L.call(this, s), this._currentZoom = s
        ...
        function k(e) {
            ...
            this.options.enforceBoundary && (i = p.width / u.width, o = p.height / u.height, r = Math.max(i, o)), r >= a && (a = r + 1), s.min = j(r, 4), s.max = j(a, 4), !e && (l < s.min || l > s.max) ? L.call(this, l < s.min ? s.min : s.max) : e && (n = Math.max(h.width / u.width, h.height / u.height), t = null !== this.data.boundZoom ? this.data.boundZoom : n, L.call(this, t)), c(s)
        }
        ...
        function O(e, t) {
            ...
            if ("string" == typeof e) n = e, e = {};
                ...
                n = e.url, s = e.points || [], l = void 0 === e.zoom ? null : e.zoom
            }
            return a.data.bound = !1, a.data.url = n || a.data.url, a.data.boundZoom = l, (i = n, o = h, r = new Image, r.style.opacity = 0, new Promise(function(e) {
                function t() {
                ...
                if (function(e) {
                    ...
                    var i, o, r = v(n),
                        ...
                        h = l.width / l.height;
                    r.width / r.height > h ? i = (o = r.height) * h : (i = r.width, o = r.height / h);
                    var u = (r.width - i) / 2,
                        c = (r.height - o) / 2,
                        p = u + i,
                        d = c + o;
                ...
                a.data.points = s.map(function(e) {
                    ...
                    var t = this.elements.canvas,
                        ...
                        i = t.getContext("2d"),
                        o = E.call(this);
                    e = this.options.enableOrientation && e, i.clearRect(0, 0, t.width, t.height), t.width = n.width, t.height = n.height, o && !e ? x(t, n, f(b(n) || 0)) : e && x(t, n, e)
        ...
        function H() {
            ...
            return n = Math.max(h, n / l), i = Math.max(h, i / l), a = Math.max(h, a / l), s = Math.max(h, s / l), {
                    ...
                    default:
                        e(function(e) {
                            var t = e.points,
                                ...
                                o = t[2] - t[0],
                                r = t[3] - t[1];
                            return d(n, "croppie-result"), n.appendChild(i), p(i, {
                                left: -1 * t[0] + "px",
                                top: -1 * t[1] + "px"
                            }), i.src = e.url, p(n, {
                                width: o + "px",
        ...
        function D(e) {
            ...
            }(this.data.orientation, e), x(t, this.elements.img, this.data.orientation), k.call(this), _.call(this), copy = null
        }
        if (window.jQuery) {
            var T = window.jQuery;
            T.fn.croppie = function(e) {
                if ("string" === typeof e) {
                    ...
                    return "get" === e ? n.get() : "result" === e ? n.result.apply(n, t) : "bind" === e ? n.bind.apply(n, t) : this.each(function() {
                        ...
                        if (n) {
                            var i = n[e];
                            if (!T.isFunction(i)) throw "Croppie " + e + " method not found";
